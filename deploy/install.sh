...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/CouplingArtist/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="CouplingArtist/sub2api"
...
Documentation=https://github.com/CouplingArtist/sub2api
